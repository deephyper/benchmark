...
problem.add_hyperparameter(["tucker", "cp", "tt", 'dense'], 'factorization', default_value="dense")
#10 learning_rate: this is the learning_rate, goes into the optimizer definition
problem.add_hyperparameter((1e-6, 1e-2, "log-uniform"), "opt_learning_rate", default_value=5e-3)
...
problem.add_hyperparameter((1e-6, 1e-2, "log-uniform"), "opt_weight_decay", default_value=1e-4)
...
problem.add_hyperparameter(['factorized', 'reconstructed'], 'implementation', default_value='factorized')
...
problem.add_hyperparameter(['full','half', 'mixed'], 'fno_block_precision', default_value='half')
#Type of skip connection to use,
problem.add_hyperparameter(['soft-gating','identity', 'linear'], 'skip', default_value='linear')
...
problem.add_hyperparameter(['StepLR', 'CosineAnnealingLR', 'ReduceLROnPlateau'], "opt_scheduler", default_value='StepLR')
